...
if __name__ == '__main__':
    ...
    out_path = sys.argv[5]
    flag = int(sys.argv[6])
    time = sys.argv[7].split(',')
    parameters_list = sys.argv[8].split(',')
    ...
    if task_id==1:
        SWAT_output_basin(folder_path,begin_year,end_year,parameters_list,out_path,flag,time)
        print('finished')
    elif task_id==2:
        ...
        SWAT_rch_space_data(folder_path,begin_year,end_year,parameters_list,out_path,flag)
        print('finished')
    elif task_id==5:
